...
internal class EvalInfo
{
    ...
    internal BitboardT[,] attackedBy = new BitboardT[Color.COLOR_NB, PieceType.PIECE_TYPE_NB];
    ...
    internal BitboardT[] kingRing = new BitboardT[Color.COLOR_NB];

    internal Pawns.Entry pi;

    internal BitboardT[] pinnedPieces = new BitboardT[Color.COLOR_NB];
};