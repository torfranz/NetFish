...
public static class Eval
{
    ...
    public static Score[][] MobilityBonus =
    {
        ...
        new[]
        {
            Score.make_score(-68, -49), Score.make_score(-46, -33), Score.make_score(-3, -12), Score.make_score(5, -4),
            Score.make_score(9, 11), Score.make_score(15, 16), // Knights
            Score.make_score(23, 27), Score.make_score(33, 28), Score.make_score(37, 29)
        },
        new[]
        {
            Score.make_score(-49, -44), Score.make_score(-23, -16), Score.make_score(16, 1), Score.make_score(29, 16),
            Score.make_score(40, 25), Score.make_score(51, 34), // Bishops
            Score.make_score(55, 43), Score.make_score(61, 49), Score.make_score(64, 51), Score.make_score(68, 52),
            Score.make_score(73, 55), Score.make_score(75, 60),
            Score.make_score(80, 65), Score.make_score(86, 66)
        },
        new[]
        {
            Score.make_score(-50, -57), Score.make_score(-28, -22), Score.make_score(-11, 7), Score.make_score(-1, 29),
            Score.make_score(0, 39), Score.make_score(1, 46), // Rooks
            Score.make_score(10, 66), Score.make_score(16, 79), Score.make_score(22, 86), Score.make_score(23, 103),
            Score.make_score(30, 109), Score.make_score(33, 111),
            Score.make_score(37, 115), Score.make_score(38, 119), Score.make_score(48, 124)
        },
        new[]
        {
            Score.make_score(-43, -30), Score.make_score(-27, -15), Score.make_score(1, -5), Score.make_score(2, -3),
            Score.make_score(14, 10), Score.make_score(18, 24), // Queens
            Score.make_score(20, 27), Score.make_score(33, 37), Score.make_score(33, 38), Score.make_score(34, 43),
            Score.make_score(40, 46), Score.make_score(43, 56),
            Score.make_score(46, 61), Score.make_score(52, 63), Score.make_score(52, 63), Score.make_score(57, 65),
            Score.make_score(60, 70), Score.make_score(61, 74),
            Score.make_score(67, 80), Score.make_score(76, 82), Score.make_score(77, 88), Score.make_score(82, 94),
            Score.make_score(86, 95), Score.make_score(90, 96),
            Score.make_score(94, 99), Score.make_score(96, 100), Score.make_score(99, 111), Score.make_score(99, 112)
        }
    };
    ...
    public static Score[][][] Threat =
    {
        new[]
        {
            new[]
            {
                Score.make_score(0, 0), Score.make_score(0, 0), Score.make_score(19, 37), Score.make_score(24, 37),
                Score.make_score(44, 97), Score.make_score(35, 106)
            }, // Minor on Defended
            new[]
            {
                Score.make_score(0, 0), Score.make_score(0, 0), Score.make_score(9, 14), Score.make_score(9, 14),
        ...
        new[]
        {
            new[]
            {
                Score.make_score(0, 0), Score.make_score(0, 32), Score.make_score(33, 41), Score.make_score(31, 50),
                Score.make_score(41, 100), Score.make_score(35, 104)
            }, // Minor on Weak
            new[]
            {
                Score.make_score(0, 0), Score.make_score(0, 27), Score.make_score(26, 57), Score.make_score(26, 57),
    ...
    {
        Score.make_score(0, 0), Score.make_score(0, 0), Score.make_score(107, 138), Score.make_score(84, 122),
...
// We don't use a Score because we process the two components independently.
    ...
    {
        new[] {new Value(0), new Value(1), new Value(34), new Value(90), new Value(214), new Value(328)},
        new[] {new Value(7), new Value(14), new Value(37), new Value(63), new Value(134), new Value(189)}
    };

    // PassedFile[File] contains a bonus according to the file of a passed pawn.
    public static Score[] PassedFile =
    {
        Score.make_score(14, 13), Score.make_score(2, 5), Score.make_score(-3, -4), Score.make_score(-19, -14),
        Score.make_score(-19, -14), Score.make_score(-3, -4), Score.make_score(2, 5), Score.make_score(14, 13)
    };
...
// happen in Chess960 games.
        ...
        Bitboard[] mobilityArea)
    {
        ...
        foreach (var s in pl.TakeWhile(s1 => s1 != Square.SQ_NONE))
        {
            ...
            b = Pt == PieceType.BISHOP
                ...
                : Pt == PieceType.ROOK
                    ? Utils.attacks_bb(PieceType.ROOK, s, pos.pieces() ^ pos.pieces(Us, PieceType.ROOK, PieceType.QUEEN))
            ...
            if (Pt == PieceType.QUEEN)
                b &= ~(ei.attackedBy[Them, PieceType.KNIGHT]
                       | ei.attackedBy[Them, PieceType.BISHOP]
            ...
            if (Pt == PieceType.BISHOP || Pt == PieceType.KNIGHT)
            {
                ...
                if (Rank.relative_rank(Us, s) >= Rank.RANK_4
                    && Rank.relative_rank(Us, s) <= Rank.RANK_6
                ...
                if (Rank.relative_rank(Us, s) < Rank.RANK_5
                    && (pos.pieces(PieceType.PAWN) & (s + Square.pawn_push(Us))))
    ...
    private static Score evaluate_king(Color Us, bool DoTrace, Position pos, EvalInfo ei)
    {
        ...
        if (ei.kingAttackersCount[Them] != 0)
        {
            ...
            undefended = ei.attackedBy[Them, PieceType.ALL_PIECES]
                         & ei.attackedBy[Us, PieceType.KING]
            ...
            attackUnits = Math.Min(72, ei.kingAttackersCount[Them]*ei.kingAttackersWeight[Them])
                          ...
                          + 27*Bitcount.popcount_Max15(undefended)
                          + 11*(ei.pinnedPieces[Us] != 0 ? 1 : 0)
                          - 64*(pos.count(PieceType.QUEEN, Them) == 0 ? 1 : 0)
                          - Score.mg_value(score)/8;
...
// Analyse the enemy's safe distance checks for sliders and knights
    ...
    private static Score evaluate_threats(Color Us, bool DoTrace, Position pos, EvalInfo ei)
    {
        ...
        if (weak)
        {
            b = pos.pieces(Us, PieceType.PAWN) & (~ei.attackedBy[Them, PieceType.ALL_PIECES]
                                                  | ei.attackedBy[Us, PieceType.ALL_PIECES]);
...
// Non-pawn enemies defended by a pawn
        ...
        weak = pos.pieces(Them)
               & ~ei.attackedBy[Them, PieceType.PAWN]
               & ei.attackedBy[Us, PieceType.ALL_PIECES];
        ...
        b = (Bitboard.shift_bb(Left, b) | Bitboard.shift_bb(Right, b))
            & pos.pieces(Them)
    ...
    private static Value evaluate(bool DoTrace, Position pos)
    {
        ...
        Bitboard[] blockedPawns =
        {
            ...
            (Bitboard.shift_bb(Square.DELTA_S, pos.pieces()) | Bitboard.Rank2BB | Bitboard.Rank3BB),
            pos.pieces(Color.BLACK, PieceType.PAWN) &
            (Bitboard.shift_bb(Square.DELTA_N, pos.pieces()) | Bitboard.Rank7BB | Bitboard.Rank6BB)
        };
...
// Scale winning side if position is more drawish than it appears
            ...
            && (sf == ScaleFactor.SCALE_FACTOR_NORMAL || sf == ScaleFactor.SCALE_FACTOR_ONEPAWN))
        {
            ...
            // pawns are drawish.
            else if (Math.Abs(Score.eg_value(score)) <= Value.BishopValueEg
