...
internal class Material
{
    ...
    private static readonly EndgameScaleFactor[] ScaleKPKP =
        {
            new EndgameKPKP(Color.WHITE),
            new EndgameKPKP(Color.BLACK)
        };

    private static readonly EndgameScaleFactor[] ScaleKPsK =
        {
            new EndgameKPsK(Color.WHITE),
            new EndgameKPsK(Color.BLACK)
        };
    ...
    {
        return !Bitboard.more_than_one(pos.pieces_Ct(Color.opposite(us)))
